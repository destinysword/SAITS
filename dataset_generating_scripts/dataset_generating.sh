...
python ./SAITS/dataset_generating_scripts/gene_PhysioNet2012_dataset.py \
...
python ./SAITS/dataset_generating_scripts/gene_UCI_BeijingAirQuality_dataset.py \
...
python ./SAITS/dataset_generating_scripts/gene_UCI_electricity_dataset.py \
